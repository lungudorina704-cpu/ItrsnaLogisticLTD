...
const sampleTrackingData: Record<string, TrackingData> = {
  ...
  events: [
    ...
    { date: 'Aug 31', time: '06:30 AM', location: 'Dehradun, India', status: 'Arrived at destination facility', completed: true },
  ...
  events: [
    ...
    { date: 'July 30', time: '06:30 AM', location: 'Vienna, Austria', status: 'Arrived at destination facility', completed: true },
  ...
  events: [
    ...
    { date: 'September 11', time: '08:00 AM', location: 'Aguaí, São Paulo (SP), Brazil', status: 'Arrived at destination facility', completed: true },
    { date: 'September 11', time: '11:30 AM', location: 'Aguaí, São Paulo (SP), Brazil', status: 'Customs awaiting clearance pending', completed: false },
  ...
  events: [
    ...
    { date: 'September 03', time: '07:30 AM', location: 'Austria', status: 'Arrived at destination facility', completed: true },
    { date: 'September 03', time: '09:30 AM', location: 'Austria', status: 'Held in customs awaiting clearance', completed: false },
  ...
  status: 'in transit',
  events: [
    { date: 'August 2', time: '09:00 AM', location: 'Tripoli, Libya', status: 'Shipment information received', completed: true },
    { date: 'August 2', time: '02:30 PM', location: 'Tripoli Airport (LB), libya', status: 'Package accepted and processed at origin facility', completed: true },
    { date: 'August 3', time: '07:15 AM', location: 'Tripoli, libya', status: 'In transit to destination', completed: true },
    { date: 'August 5', time: '08:00 AM', location: 'Moscow, Russia', status: 'Arrived at destination facility', completed: true },
    { date: 'August 5', time: '11:30 AM', location: 'Moscow, Russia', status: 'Held in customs awaiting clearance', completed: false },
    { date: 'August 5', time: '03:00 PM', location: 'Moscow, Russia', status: 'Out for delivery', completed: false }
  ]
},

'ITR78738309': {
  trackingNumber: 'ITR78738309',
  origin: 'Tel Aviv, Israel',
  destination: 'Hofgeismar, Germany',
  estimatedDelivery: 'August 23, 2026',
  status: 'in transit',
  events: [
    { date: 'August 20', time: '01:00 PM', location: 'Tel Aviv, Israel', status: 'Shipment information received', completed: true },
    { date: 'August 20', time: '03:30 PM', location: 'Tel Aviv Airport (TLV), Israel', status: 'Package accepted and processed at origin facility', completed: true },
    { date: 'August 21', time: '07:45 AM', location: 'Tel Aviv, Israel', status: 'In transit to destination', completed: true },
    { date: 'August 23', time: '08:00 AM', location: 'Hofgeismar, Germany', status: 'Arrived at destination facility', completed: true },
    { date: 'August 23', time: '11:30 AM', location: 'Hofgeismar, Germany', status: 'Customs awaiting clearance', completed: false },
    { date: 'August 23', time: '03:00 PM', location: 'Hofgeismar, Germany', status: 'Out for delivery', completed: false }
  ]
},

  'ITR78738209': {
  trackingNumber: 'ITR78738209',
  origin: 'Tel Aviv, Israel',
  destination: 'Kleinwallstadt, Germany',
